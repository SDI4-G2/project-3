                ...
                <View>
                    <View style={styles.fieldsInput}>
                        <View style={styles.userInput}>
                            <Text style={{textAlign: "center", color: 'rgba(255,255,255, 0.6)'}}>
            ...
            :
                <View>
                    <View style={styles.fieldsInput}>
                        ...
                        <View style={styles.userInput}>
                            <Text style={{textAlign: "center", color: 'rgba(255,255,255, 0.6)'}}>- Access to all content</Text>
                            <Text style={{textAlign: "center", color: 'rgba(255,255,255, 0.6)'}}>- Skip advertisements"</Text>
                        </View>
                        </View>

                        <View style={{ flexDirection: 'row', alignContent: 'center', marginTop: 15, marginBottom: 15 }}>
