import { View, Text, TouchableOpacity, StyleSheet, ScrollView, Button, ActivityIndicator, Image, ImageBackground } from 'react-native';
          ...
          {showSearchImage ? (
            <>
              ...
              <View style={{ top: '40%', alignSelf: 'center' }}>
                <Small fontSmall={'Type anything to find what you are looking for.'} />
              </View>
            </>
          ) : null}
