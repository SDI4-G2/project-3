  ...
  return (
    <SafeAreaView>
      ...
      <View style={styles.container}>
        ...
        <View style={{ paddingBottom: "5%" }}>
          <Med
            fontMed={"Please enter your new password."}
          ></Med>
        </View>
              ...
              <TouchableOpacity
                 ...
                 disabled={password.length < 6 || email.length < 6 || confirmPassword.length < 6}
                  onPress={() =>
                    ResetPassword({ email, password, confirmPassword, navigation }, setIsLoading(true))
