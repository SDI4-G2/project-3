...
export default function Modal({ usernameInput, useremailInput, textForInput, navigation }) {
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  disabled={username.length < 6 || email.length < 6 || password.length < 6}
                  onPress={async () => await EditUsername({ email, username, password, navigation }).then((res) => setVisible(res))}
                >
